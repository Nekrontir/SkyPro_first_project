...
def sort_by_date(dict_list: list[dict], direction: bool=True) -> list[dict]:
    """
    ...
    new_dict_list = sorted(dict_list, key=lambda x: datetime.fromisoformat(x['date']), reverse=direction)
